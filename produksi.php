				...
				<div class="row">
					<div class="col-md-12 col-lg-12 col-xl-12">
						<section class="panel">
							...
							<h3><strong><center>Kegiatan Bidang/ Fungsi Statistik Produksi</center></strong></h3>
								<hr>
								<table class="table table-bordered table-striped mb-none" id="sosial" data-swf-path="https://cdn.datatables.net/tabletools/2.2.4/swf/copy_csv_xls_pdf.swf">
									...
									<tbody>
                    					...
                    					<tr>
                    						...
                    						<td><?php echo ucwords($row['uraian']) . ' pada Kegiatan (' . $row['kegiatan'] . ') dengan satuan hasil: (' . $row['satuan'] . ')'; ?></td>
