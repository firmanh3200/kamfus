                        ...
                        <div class="panel-body">
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    <input type="hidden" class="form-control" name="ak[]" value="<?php echo $row['ak']; ?>">
                                                </td>
                                            </tr>
                                    <?php
                                        }
                            ...
                            <form id="formLaporan" action="simpan_akbaru.php" method="post">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select name="kode_kegiatan" id="kode_kegiatan" required>
                                            ...
                                            while ($row = mysqli_fetch_assoc($resultKegiatan)) {
                                                ...
                                                $v = $row['kode_kegiatan'];
                                                echo "<option value='$v'" . ($selectedKegiatan == $option ? ' selected' : '') . ">$option</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                                ...
                                <div class="row table">
                                    ...
                                    <div class="col-md-2">
                                        <button type="submit" name="SimpanLaporanBaru" id="submitBtn" class="btn btn-success">Simpan Laporan</button>
                                    </div>
                                    <div class="col-md-2">
                                        <a class="btn btn-info" href="laporanjftbaru.php">Lihat Laporan</a>
                                    </div>
                                </div>
                            </form>
                        </div>
