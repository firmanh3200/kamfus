				...
				<div class="row">
					<div class="col-md-12 col-lg-12 col-xl-12">
						<section class="panel">
							...
							<h3><strong><center>Master Angka Kredit PerMenPAN-RB 2022</center></strong></h3>
								<hr>
								<table class="table table-bordered table-striped mb-none" id="sosial" data-swf-path="https://cdn.datatables.net/tabletools/2.2.4/swf/copy_csv_xls_pdf.swf">
									...
									<tbody>
                    					<?php
										$qry = $conn->query("SELECT * FROM tbl_akbaru order by pelaksana asc");
                    					...
                    					<tr>
											...
											<td class="text-center"><?php echo ucwords($row['ak'])?></td>
										</tr>	
                    				<?php endwhile; ?>
                    				</tbody>
								</table>
