...
$query1 = "SELECT DISTINCT pjk FROM kamus WHERE kode_pelaksana = '6' ORDER BY pjk ASC";
...
if (isset($_POST['submit'])) {
    ...
    $query2 = "SELECT DISTINCT kegiatan FROM kamus WHERE kode_pelaksana = '6' AND pjk = '$selectedColumn1' ORDER BY kegiatan ASC";
    $result2 = mysqli_query($conn, $query2);

    // Fetch options for third column based on selected values from column1 and column2
    $query3 = "SELECT DISTINCT uraian FROM kamus WHERE kode_pelaksana = '6' AND pjk = '$selectedColumn1' AND kegiatan = '$selectedColumn2' ORDER BY uraian ASC";
    $result3 = mysqli_query($conn, $query3);

    // Fetch options for third column based on selected values from column1 and column2 and column3
    $query4 = "SELECT DISTINCT satuan FROM kamus WHERE kode_pelaksana = '6' AND pjk = '$selectedColumn1' AND kegiatan = '$selectedColumn2' AND uraian = '$selectedColumn3' ORDER BY satuan ASC";
...
<body class="index-page">
  <div class="wrapper">
    ...
    <div class="container">
      ...
      <h3>Angka Kredit Statistisi Pertama</h3>
        <form method="post">
          <div class="row">
            <div class="col-md-12">
              ...
              if (isset($_POST['submit'])) {
                  if (mysqli_num_rows($resultResult) > 0) {
                      ...
                      if (isset($volume) && $volume != '') {
                          ...
                          $calculationResult = "<div><h4>Kesimpulan:<br><br> Pejabat Fungsional Statistisi Pertama, dari Pekerjaan <b>" . $selectedColumn3 .", pada " . $selectedColumn2 . ", sebanyak " . $volume . " " . $column3Value . ", memperoleh Angka Kredit sebesar: " . $formatted_result . "</b></h4><p>-- Sumber: PerKa BPS No. 59 Th. 2014</p></div>";
                      } else {
